data modify storage pandamium:global restart_kick_message set value "We've just completed a regularly scheduled server restart to help with performance! You may join back in 1-2 minutes."
