...
execute if score <mainhand> variable matches 0 store result score <held_version> variable run data get entity @s equipment.offhand.components."minecraft:custom_data".pandamium.guidebook.version
