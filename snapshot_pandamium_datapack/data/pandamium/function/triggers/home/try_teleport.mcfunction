...
execute if score <surface> variable matches 0 run tellraw @s [{text:"",color:"green"},{text:"[Homes]",color:"dark_green"}," Teleported to ",{storage:"pandamium:temp",nbt:"home_name",interpret:true},"!"]
