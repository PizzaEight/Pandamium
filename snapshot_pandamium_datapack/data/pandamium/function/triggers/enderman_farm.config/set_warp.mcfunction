...
execute unless dimension the_end run return run tellraw @s [{text:"[Enderman Farm]",color:"dark_red"},{text:" Failed to set ",color:"red",extra:[{text:"Enderman Farm",color:"yellow"}," warp here! This warp can only be set in ",{storage:"pandamium:dictionary",nbt:"dimension.minecraft:the_end.name",interpret:true,color:"yellow"},"."]}]
execute unless loaded ~ ~ ~ run return run tellraw @s [{text:"[Enderman Farm]",color:"dark_red"},{text:" Failed to set ",color:"red",extra:[{text:"Enderman Farm",color:"yellow"}," warp here! This is not a loaded position."]}]
execute unless block ~ ~ ~ #pandamium:no_solid_collision run return run tellraw @s [{text:"[Enderman Farm]",color:"dark_red"},{text:" Failed to set ",color:"red",extra:[{text:"Enderman Farm",color:"yellow"}," warp here! There is not enough space for players to stand here."]}]
execute unless block ~ ~1 ~ #pandamium:no_solid_collision run return run tellraw @s [{text:"[Enderman Farm]",color:"dark_red"},{text:" Failed to set ",color:"red",extra:[{text:"Enderman Farm",color:"yellow"}," warp here! There is not enough space for players to stand here."]}]
...
execute unless block ~ ~-1 ~ #pandamium:warp_platform_cannot_replace run setblock ~ ~-1 ~ bedrock strict
...
execute align xyz run particle minecraft:falling_dust{block_state:"minecraft:ice"} ~.5 ~.5 ~.5
function pandamium:triggers/enderman_farm.config/print_menu
tellraw @s [{text:"[Enderman Farm]",color:"dark_green"},{text:" ",color:"green",extra:[{text:"Set",color:"aqua"}," the ",{text:"Enderman Farm",color:"aqua"}," warp at ",{storage:"pandamium:global",nbt:"enderman_farm_warp.x",color:"aqua"}," ",{storage:"pandamium:global",nbt:"enderman_farm_warp.y",color:"aqua"}," ",{storage:"pandamium:global",nbt:"enderman_farm_warp.z",color:"aqua"}," in ",{storage:"pandamium:dictionary",nbt:"dimension.minecraft:the_end.name",interpret:true,color:"aqua"},"! Protection is turned off."]}]
