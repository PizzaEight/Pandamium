...
execute if score @s options matches -601 if score <anti_bot_mode> global matches 0 run tellraw @a[predicate=pandamium:player/min_staff_perms/helper] [{text:"",color:"gray"},{text:"[Staff Info] ",color:"dark_gray"},{selector:"@s",color:"gray"}," disabled ",{text:"Anti-Bot Mode",bold:true},"!"]
...
execute if score @s options matches -601 if score <anti_bot_mode> global matches 1 run tellraw @a[predicate=pandamium:player/min_staff_perms/helper] [{text:"",color:"gray"},{text:"[Staff Info] ",color:"dark_gray"},{selector:"@s",color:"gray"}," enabled ",{text:"Anti-Bot Mode",bold:true},"!"]
...
execute if score @s options matches -602 if score <disable_tnt_auto_defuse> global matches 0 run tellraw @a[predicate=pandamium:player/min_staff_perms/helper] [{text:"",color:"gray"},{text:"[Staff Info] ",color:"dark_gray"},{selector:"@s",color:"gray"}," enabled ",{text:"Auto Defuse TNT",bold:true},"!"]
...
execute if score @s options matches -602 if score <disable_tnt_auto_defuse> global matches 1 run tellraw @a[predicate=pandamium:player/min_staff_perms/helper] [{text:"",color:"gray"},{text:"[Staff Info] ",color:"dark_gray"},{selector:"@s",color:"gray"}," disabled ",{text:"Auto Defuse TNT",bold:true},"!"]
...
execute if score @s options matches -603 if score <gamerule_mob_griefing> variable matches 0 run tellraw @a[predicate=pandamium:player/min_staff_perms/helper] [{text:"",color:"gray"},{text:"[Staff Info] ",color:"dark_gray"},{selector:"@s",color:"gray"}," disabled ",{text:"Vanilla Mob Griefing Rule",bold:true},"!"]
...
execute if score @s options matches -603 if score <gamerule_mob_griefing> variable matches 1 run tellraw @a[predicate=pandamium:player/min_staff_perms/helper] [{text:"",color:"gray"},{text:"[Staff Info] ",color:"dark_gray"},{selector:"@s",color:"gray"}," enabled ",{text:"Vanilla Mob Griefing Rule",bold:true},"!"]
