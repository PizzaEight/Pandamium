...
tellraw @a[scores={send_extra_debug_info=1..},predicate=!pandamium:matches_id] [{color:"gray",italic:true,text:"["},{color:"gray",storage:"pandamium:temp",nbt:"username",interpret:true},": world_info ",{score:{name:"@s",objective:"world_info"}},"]"]
...
execute store result score <global_items_nether> variable in the_nether if entity @e[type=item]
scoreboard players operation <global_item_count> variable += <global_items_nether> variable
execute store result score <global_items_end> variable in the_end if entity @e[type=item]
scoreboard players operation <global_item_count> variable += <global_items_end> variable
...
execute unless score <global_mob_count> variable >= <mob_limit> global run tellraw @s [{text:"Global:",color:"aqua",bold:true},{text:"\n Items: ",color:"green"},{score:{name:"<global_item_count>",objective:"variable"},color:"aqua",bold:true},{text:"",color:"aqua"},{text:"\n Players: ",color:"green"},{score:{name:"<global_player_count>",objective:"variable"},color:"aqua",bold:true},{text:"\n Mobs: ",color:"green"},{score:{name:"<global_mob_count>",objective:"variable"},color:"aqua",bold:true},"/",{score:{name:"<global_mob_cap>",objective:"variable"},color:"aqua",bold:true}]
execute if score <global_mob_count> variable >= <mob_limit> global run tellraw @s [{text:"Global:",color:"aqua",bold:true},{text:"\n Items: ",color:"green"},{score:{name:"<global_item_count>",objective:"variable"},color:"aqua",bold:true},{text:"",color:"aqua"},{text:"\n Players: ",color:"green"},{score:{name:"<global_player_count>",objective:"variable"},color:"aqua",bold:true},{text:"\n Mobs: ",color:"green"},{score:{name:"<global_mob_count>",objective:"variable"},color:"aqua",bold:true,color:red},"/",{score:{name:"<global_mob_cap>",objective:"variable"},bold:true},{text:"\n Mob cap exceeded!\n No more mobs will spawn",color:red,bold:true}]
execute if score <dev_environment> global matches 1 run tellraw @s [{text:"",color:"aqua"},{text:" In Dev Mode",color:"dark_purple"}]
tellraw @s [{text:"",color:"aqua"},{text:"Overworld:",bold:true},{text:"\n Players: ",color:"green"},{score:{name:"<overworld_player_count>",objective:"variable"},bold:true},{text:"\n Sleeping Players: ",color:"green"},{score:{name:"<total_sleeping_players>",objective:"variable"},bold:true},{text:" (",color:"gray",hover_event:{action:"show_text",value:[{text:"At least ",color:"gray"},{score:{name:"<minimum_sleeping_players_required>",objective:"variable"}}," player(s) in the\noverworld are required to be\nsleeping in order to skip the\nnight."]},extra:[{score:{name:"<total_sleeping_players>",objective:"variable"}},"/",{score:{name:"<minimum_sleeping_players_required>",objective:"variable"}},")"]},{text:"\n Mobs: ",color:"green"},{score:{name:"<overworld_mob_count>",objective:"variable"},bold:true}]
